...
| 챕터 | 내용 | 표 행 / 상세 |
|---|---|---|
| [01-actors](./01-actors.md) | 사람·조직 (발주자·원도급사·하도급사·현장소장) | 13 / 6 |
| [02-trades](./02-trades.md) | 공종 분류 체계 (가설·철콘·마감·설비) | 40 / 7 |
| [03-money](./03-money.md) | 금액 개념 (원도급금액·하도급금액·실행·기성·유보 등) — 가장 큰 챕터 | 93 / 22 |
...
| [00-conflicts](./00-conflicts.md) | 충돌 누적 (업계 vs MVP) | 9 conflicts |

**합계**: 표 행 177개 · 상세 섹션 47개 (6개 도메인 챕터 기준)
...
회의에서 "기성"이라는 단어가 나왔다 → 우측 검색창에 `기성` 입력
또는 [03-money](./03-money.md) 페이지에서 찾는다 → `#문서:기성청구서` 태그가
보이면 그 문서에서 어떻게 등장하는지 [04-documents](./04-documents.md)로 점프.
